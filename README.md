...
```javascript
import * as Material from "https://cdn.jsdelivr.net/gh/xjs-org/xjs-ui@main/material/v0.1/index.js";
```

```html
<script
  src="https://cdn.jsdelivr.net/gh/xjs-org/xjs-ui@main/material/v0.1/index.js"
  crossorigin
></script>
```
